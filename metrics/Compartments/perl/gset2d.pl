...
$opix.=$pix;
	my @num=split(/\ /,$pix);
if($#num==6){
if($num[0]==2){$x=$num[6]-1;$y=$num[7];$z=$num[8];$opix.="9 9 9 9 $x $y $z\n";}
if($num[1]==2){$x=$num[6];$y=$num[7]-1;$z=$num[8];$opix.="9 9 9 9 $x $y $z\n";}
if($num[2]==2){$x=$num[6]+1;$y=$num[7];$z=$num[8];$opix.="9 9 9 9 $x $y $z\n";}
if($num[3]==2){$x=$num[6];$y=$num[7]+1;$z=$num[8];$opix.="9 9 9 9 $x $y $z\n";}
}
}
chomp($opix);
print "$i:$lines1\n";

...
#include <sstream>
#include <stdlib.h>
void print_border(std::deque<Molecule *> mols, int num_mols){
using namespace std;
...
void print_mols_fa(int t,std::deque<Molecule *> mols){
	using namespace std;
...
void print_mols_f(int t,std::deque<Molecule  *> mols,const char* file,int n_mol){
using namespace std;
...
deque<Molecule *> mols;
//cout << mols.max_size() << " Molecules Loaded "  << endl;
...
cout << "num_mols" << num_mols << ":" << i << endl;
}
cout << "Loaded Molecules" << endl;

...
{
	// Creating the Unit deque in the direction of x2,y2,z2
...
int Molecule::col_detect_b(std::deque<Molecule *> mols,double x2,double y2,double z2,double xp2, double yp2, double zp2){
	using namespace std;
...
int Molecule::col_detect(std::deque<Molecule *> mols,double x2,double y2,double z2){
	using namespace std;
	////cout << "DECTING " << num_list << "POSSIBLE COLLISIONS"<< endl;
//This determines which molecule of mols was the first to collide with molecule A, when A moves from x,y,z to x1,y1,z1
	double a;
...
void Molecule::move(std::deque<Molecule  *> mols,int num_mols,double diss[5][5],double assoc[5][5],double x_max,double x_min,double y_max, double y_min, double z_max, double z_min)
{
...
void Molecule::new_verley(std::deque<Molecule *> mols,int num_mols){
